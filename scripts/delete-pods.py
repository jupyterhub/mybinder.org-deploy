...
argparser.add_argument("--older-than", type=float, default=0, help="Pods older than this many hours will be killed (can be fractions of an hour)")
...
argparser.add_argument("--pod-name", default="", help="Only delete pods with `pod-name` in the pod name.")
